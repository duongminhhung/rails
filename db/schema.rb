...
ActiveRecord::Schema[7.1].define(version: 2024_11_10_104020) do
  ...
  create_table "user_permissions", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
